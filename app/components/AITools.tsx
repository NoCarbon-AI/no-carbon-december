...
export const AITools = () => {
  ...
  const tools = [
    { name: 'CAST AI', logo: '/Cast-Ai.png', url: 'https://cast.ai' },
    { name: 'Cloudaware', logo: '/Cloudware-logo.jpeg', url: 'https://www.cloudaware.com' },
    { name: 'CoreStack', logo: '/Corestack-logo.png', url: 'https://www.corestack.io' },
    { name: 'Resolve AI', logo: '/Resolve-logo.jpeg', url: 'https://resolve.ai' },
    { name: 'MindsDB', logo: '/Mindsdb-logo.png', url: 'https://mindsdb.com' }
  ];
